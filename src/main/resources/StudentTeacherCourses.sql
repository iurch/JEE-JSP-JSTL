...
CREATE TABLE IF NOT EXISTS `course_management`.`Course_Student` (
  ...
  PRIMARY KEY (`Course_id`, `Course_Teacher_id`, `Student_id`),
  INDEX `fk_Course_has_Student_Student1_idx` (`Student_id` ASC),
  INDEX `fk_Course_has_Student_Course1_idx` (`Course_id` ASC, `Course_Teacher_id` ASC),
  CONSTRAINT `fk_Course_has_Student_Course1`
    FOREIGN KEY (`Course_id` , `Course_Teacher_id`)
    REFERENCES `course_management`.`Course` (`id` , `Teacher_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
